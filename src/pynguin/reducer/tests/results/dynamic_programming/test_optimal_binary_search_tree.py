...
def test_case_0():
    int_0 = 0
    module_0.print_binary_search_tree(int_0, int_0, int_0, int_0, int_0, int_0)
...
def test_case_5():
    ...
    int_0 = -21
    none_type_0 = None
    var_0 = module_0.print_binary_search_tree(
        list_0, int_0, int_0, int_0, int_0, none_type_0
    )
    module_0.find_optimal_binary_search_tree(int_0)
...
def test_case_8():
    ...
    list_1 = [var_0, var_0]
    var_1 = var_0.__str__()
    assert var_1 == "Node(key=0, freq=0)"
