...
def test_case_1():
    ...
    assert f'{type(segment_tree_0).__module__}.{type(segment_tree_0).__qualname__}' == 'segment_tree_other.SegmentTree'
...
def test_case_6():
    ...
    assert f'{type(segment_tree_0.root).__module__}.{type(segment_tree_0.root).__qualname__}' == 'segment_tree_other.SegmentTreeNode'
