...
def test_case_0():
    ...
    assert f'{type(a_v_ltree_0.root).__module__}.{type(a_v_ltree_0.root).__qualname__}' == 'avl_tree.MyNode'
...
def test_case_17():
    ...
    assert f'{type(my_node_0.right).__module__}.{type(my_node_0.right).__qualname__}' == 'avl_tree.MyNode'
    assert my_node_0.height == 2
    assert f'{type(var_1).__module__}.{type(var_1).__qualname__}' == 'avl_tree.MyNode'
    assert var_1.data == ()
    assert var_1.left is None
    assert f'{type(var_1.right).__module__}.{type(var_1.right).__qualname__}' == 'avl_tree.MyNode'
...
def test_case_21():
    ...
    assert f'{type(a_v_ltree_1.root).__module__}.{type(a_v_ltree_1.root).__qualname__}' == 'avl_tree.MyNode'
...
def test_case_23():
    ...
    assert f'{type(a_v_ltree_2.root).__module__}.{type(a_v_ltree_2.root).__qualname__}' == 'avl_tree.MyNode'