...
def test_case_0():
    ...
    assert f'{type(binomial_heap_0.bottom_root).__module__}.{type(binomial_heap_0.bottom_root).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(binomial_heap_0.min_node).__module__}.{type(binomial_heap_0.min_node).__qualname__}' == 'binomial_heap.Node'
...
def test_case_4():
    ...
    assert f'{type(binomial_heap_1.bottom_root).__module__}.{type(binomial_heap_1.bottom_root).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(binomial_heap_1.min_node).__module__}.{type(binomial_heap_1.min_node).__qualname__}' == 'binomial_heap.Node'
    ...
    assert f'{type(var_3).__module__}.{type(var_3).__qualname__}' == 'binomial_heap.BinomialHeap'
    assert var_3.size == 1
    assert f'{type(var_3.bottom_root).__module__}.{type(var_3.bottom_root).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(var_3.min_node).__module__}.{type(var_3.min_node).__qualname__}' == 'binomial_heap.Node'
...
def test_case_8():
    ...
    assert binomial_heap_1.size == 0
    assert binomial_heap_1.min_node is None
    assert f'{type(var_2).__module__}.{type(var_2).__qualname__}' == 'binomial_heap.BinomialHeap'
    assert var_2.size == 1
    assert f'{type(var_2.bottom_root).__module__}.{type(var_2.bottom_root).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(var_2.min_node).__module__}.{type(var_2.min_node).__qualname__}' == 'binomial_heap.Node'
...
def test_case_9():
    ...
    assert f'{type(binomial_heap_0.size).__module__}.{type(binomial_heap_0.size).__qualname__}' == 'binomial_heap.BinomialHeap'
...
def test_case_13():
    ...
    assert f'{type(node_0.right).__module__}.{type(node_0.right).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(var_0).__module__}.{type(var_0).__qualname__}' == 'binomial_heap.Node'
    assert var_0.val == pytest.approx(1510.0422, abs=0.01, rel=0.01)
    assert var_0.left_tree_size == 1
    assert var_0.left is None
    assert f'{type(var_0.right).__module__}.{type(var_0.right).__qualname__}' == 'binomial_heap.Node'
...
def test_case_14():
    ...
    assert f'{type(node_0.left).__module__}.{type(node_0.left).__qualname__}' == 'binomial_heap.Node'
    assert f'{type(var_0.left).__module__}.{type(var_0.left).__qualname__}' == 'binomial_heap.Node'
    assert binomial_heap_0.size == 2
    var_2.is_empty()