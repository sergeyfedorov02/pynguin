...
def test_case_3():
    circular_queue_linked_list_0 = module_0.CircularQueueLinkedList()
    none_type_0 = circular_queue_linked_list_0.check_is_full()
...
def test_case_4():
    ...
    circular_queue_linked_list_1 = module_0.CircularQueueLinkedList(bool_0)
...
def test_case_7():
    ...
    assert (
        ...
        == "circular_queue_linked_list.CircularQueueLinkedList"
    )
    assert (
        f"{type(var_0.front).__module__}.{type(var_0.front).__qualname__}"
        == "circular_queue_linked_list.Node"
    )
    assert (
        f"{type(var_0.rear).__module__}.{type(var_0.rear).__qualname__}"
        == "circular_queue_linked_list.Node"
    )
