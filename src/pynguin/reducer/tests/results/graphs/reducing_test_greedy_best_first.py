...
def test_case_6():
    ...
    assert f'{type(greedy_best_first_0).__module__}.{type(greedy_best_first_0).__qualname__}' == 'greedy_best_first.GreedyBestFirst'
    assert greedy_best_first_0.grid == [[True, True, True]]
    assert f'{type(greedy_best_first_0.start).__module__}.{type(greedy_best_first_0.start).__qualname__}' == 'greedy_best_first.Node'
    assert f'{type(greedy_best_first_0.target).__module__}.{type(greedy_best_first_0.target).__qualname__}' == 'greedy_best_first.Node'
    assert f'{type(greedy_best_first_0.open_nodes).__module__}.{type(greedy_best_first_0.open_nodes).__qualname__}' == 'builtins.list'
...
def test_case_9():
    ...
    greedy_best_first_0 = module_0.GreedyBestFirst(list_1, tuple_0, list_0)
    assert f'{type(greedy_best_first_0).__module__}.{type(greedy_best_first_0).__qualname__}' == 'greedy_best_first.GreedyBestFirst'
    assert greedy_best_first_0.grid == [[False, False, False, False], [False, False, False, False]]
    assert f'{type(greedy_best_first_0.start).__module__}.{type(greedy_best_first_0.start).__qualname__}' == 'greedy_best_first.Node'
    assert f'{type(greedy_best_first_0.target).__module__}.{type(greedy_best_first_0.target).__qualname__}' == 'greedy_best_first.Node'
    assert f'{type(greedy_best_first_0.open_nodes).__module__}.{type(greedy_best_first_0.open_nodes).__qualname__}' == 'builtins.list'
    assert len(greedy_best_first_0.open_nodes) == 1
