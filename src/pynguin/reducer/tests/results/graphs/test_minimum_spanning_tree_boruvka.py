...
def test_case_0():
    ...
    graph_1 = graph_0.add_edge(var_0, graph_0, var_0)
...
def test_case_2():
    ...
    assert (
        ...
        == "minimum_spanning_tree_boruvka.Graph"
    )
...
def test_case_5():
    ...
    assert (
        f"{type(var_2.adjacency).__module__}.{type(var_2.adjacency).__qualname__}"
        == "builtins.dict"
    )
...
def test_case_10():
    graph_0 = module_0.Graph()
    assert graph_0.num_edges == 0
    var_0 = graph_0.add_vertex(graph_0)
    assert graph_0.num_vertices == 1
    assert len(graph_0.adjacency) == 1
    var_1 = graph_0.distinct_weight()
    var_2 = graph_0.__str__()
    assert var_2 == ""
    var_3 = graph_0.boruvka_mst(graph_0)
    assert (
        f"{type(var_3).__module__}.{type(var_3).__qualname__}"
        == "minimum_spanning_tree_boruvka.Graph"
    )
    assert var_3.num_vertices == 0
    assert var_3.num_edges == 0
    assert var_3.adjacency == {}
    var_4 = graph_0.add_edge(graph_0, var_2, var_2)
    assert graph_0.num_vertices == 2
    assert len(graph_0.adjacency) == 2
    graph_0.__str__()
...
def test_case_11():
    ...
    var_3 = graph_0.get_vertices()
    graph_1 = module_0.Graph()
    assert graph_1.num_edges == 0
    var_4 = graph_0.get_edges()
    var_5 = graph_1.get_vertices()
    var_6 = var_0.distinct_weight()
    var_7 = graph_1.get_edges()
    graph_2 = module_0.Graph()
    assert graph_2.num_edges == 0
    var_8 = graph_2.add_edge(var_1, graph_0, var_1)
    assert graph_2.num_vertices == 2
    graph_1.boruvka_mst(graph_0)
