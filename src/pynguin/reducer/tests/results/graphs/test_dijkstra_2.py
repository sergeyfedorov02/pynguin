...
def test_case_1():
    bool_0 = False
    var_0 = module_0.print_dist(bool_0, bool_0)


def test_case_2():
    bool_0 = False
    var_0 = module_0.print_dist(bool_0, bool_0)
    var_1 = module_0.min_dist(var_0, bool_0, bool_0)
    assert var_1 == -1
...
def test_case_6():
    bool_0 = True
    module_0.min_dist(bool_0, bool_0, bool_0)
...
def test_case_7():
    ...
    assert var_0 == -1
    var_1 = module_0.min_dist(var_0, bool_0, var_0)
    assert var_1 == -1
    var_2 = module_0.print_dist(var_0, bool_0)
    var_3 = module_0.min_dist(var_2, var_2, var_1)
    assert var_3 == -1
    bool_1 = True
    module_0.dijkstra(bool_0, bool_1, var_0)
